...
export default function CreateTicketPage() {
      ...
      await creation.submit(
        {
          ...
          category:
            ...
            (activeSelection ? selectedTemplate?.category || selectedPreset?.category : undefined),
          templateId,
        ...
        receipt => router.push(`/tickets/${receipt.workItemId}`)
      );
    } catch (e: unknown) {
  ...
  if (!genericChosen)
    return (
      <Card className="m-6" title="选择创建目标">
  ...
  return (
    <div className="max-w-7xl mx-auto p-[16px] md:p-[24px]" role="main" aria-label="创建工单页面">
      <Alert
        type="info"
        title="当前目标：普通工单"
        description="模板提供普通工单字段；专业工作请返回创建入口重新选择。"
      />
      ...
      <Space orientation="vertical" size={16} style={{ width: '100%' }}>
        ...
        <Card>
          <Space align="center" style={{ width: '100%' }}>
            ...
            <div style={{ flex: 1 }}>
              <Title level={4} style={{ fontSize: 24, fontWeight: 600, marginBottom: 4 }}>
                新建工单
              </Title>
