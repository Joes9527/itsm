...
const TicketBatchOperationsContent: React.FC<TicketBatchOperationsProps> = ({
  selectedTickets,
  onOperationComplete,
  onSelectionClear,
}) => {
...
const TicketBatchOperations: React.FC<TicketBatchOperationsProps> = props => {
  const identity = useDetailIdentity('ticket-batch');
  return <TicketBatchOperationsContent key={identity} {...props} />;
};
