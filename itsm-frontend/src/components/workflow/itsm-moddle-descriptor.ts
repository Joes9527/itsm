const itsmModdleDescriptor = {
  ...
  types: [{
    ...
    properties: [
      ...
      { name: 'assigneeTeamId', isAttr: true, type: 'Integer' },
      { name: 'assigneeProjectId', isAttr: true, type: 'Integer' },
      { name: 'assigneeTempTeamId', isAttr: true, type: 'Integer' },
      { name: 'assigneeGmChain', isAttr: true, type: 'Boolean' },
      { name: 'assigneeDirectManager', isAttr: true, type: 'Boolean' },
      { name: 'assigneeManagerLevel', isAttr: true, type: 'Integer' },
