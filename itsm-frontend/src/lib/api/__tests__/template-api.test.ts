...
describe('TemplateApi', () => {
  ...
  describe('getTemplates', () => {
    it('should get templates', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates', { page: 1, pageSize: 10 });
    });
  });
  ...
  describe('createTemplate', () => {
    it('should create template', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates', { name: 'New' });
    });
  });
  ...
  describe('updateTemplate', () => {
    it('should update template', async () => {
      ...
      expect(mockPatch).toHaveBeenCalledWith('/api/v1/tickets/templates/1', { name: 'Updated' });
    });
  });
  ...
  describe('archiveTemplate', () => {
    it('should archive', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/1/archive');
    });
  });
  ...
  describe('unarchiveTemplate', () => {
    it('should unarchive', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/1/unarchive');
    });
  });
  ...
  describe('publishTemplate', () => {
    it('should publish', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/1/publish', { changelog: 'v1.0 release' });
    });
  });
  ...
  describe('createDraft', () => {
    it('should create draft', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/1/draft');
    });
  });
  ...
  describe('getTemplateVersions', () => {
    it('should get versions', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/1/versions');
    });
  });
  ...
  describe('rollbackToVersion', () => {
    it('should rollback', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/1/rollback', { version: 'v2' });
    });
  });
  ...
  describe('compareVersions', () => {
    it('should compare versions', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/1/compare', { versionA: 'v1', versionB: 'v2' });
    });
  });
  ...
  describe('createCategory', () => {
    it('should create category', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/categories', { name: 'IT' });
    });
  });
  ...
  describe('updateCategory', () => {
    it('should update category', async () => {
      ...
      expect(mockPatch).toHaveBeenCalledWith('/api/v1/tickets/templates/categories/1', { name: 'Updated' });
    });
  });
  ...
  describe('deleteCategory', () => {
    it('should delete category', async () => {
      ...
      expect(mockDelete).toHaveBeenCalledWith('/api/v1/tickets/templates/categories/1');
    });
  });
  ...
  describe('getTemplateStats', () => {
    it('should get stats', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/1/stats');
    });
  });
  ...
  describe('recordTemplateUsage', () => {
    it('should record usage', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/1/use');
    });
  });
  ...
  describe('getRecentTemplates', () => {
    it('should get recent templates', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/recent', { limit: 5 });
    });
  });
  ...
  describe('getPopularTemplates', () => {
    it('should get popular templates', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/popular', { limit: 5 });
    });
  });
  ...
  describe('rateTemplate', () => {
    it('should rate template', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/1/rate', { rating: 5, comment: 'great' });
    });
  });
  ...
  describe('getTemplateRatings', () => {
    it('should get ratings', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/1/ratings');
    });
  });
  ...
  describe('duplicateTemplate', () => {
    it('should duplicate', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/duplicate', { templateId: '1', name: 'Copy' });
    });
  });
  ...
  describe('exportTemplate', () => {
    it('should export', async () => {
      ...
      expect(mockRequest).toHaveBeenCalledWith(expect.objectContaining({ method: 'GET', url: '/api/v1/tickets/templates/1/export', responseType: 'blob' }));
    });
  });
  ...
  describe('validateTemplate', () => {
    it('should validate', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/validate', { name: 'Test' });
    });
  });
  ...
  describe('checkTemplateName', () => {
    it('should check name availability', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/check-name', { name: 'NewName', excludeId: '1' });
    });
  });
  ...
  describe('batchToggleTemplates', () => {
    it('should batch toggle', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/batch/toggle', { templateIds: ['1', '2'], isActive: true });
    });
  });
  ...
  describe('batchDeleteTemplates', () => {
    it('should batch delete', async () => {
      ...
      expect(mockRequest).toHaveBeenCalledWith({ method: 'DELETE', url: '/api/v1/tickets/templates/batch', data: { templateIds: ['1', '2'] } });
    });
  });
  ...
  describe('searchTemplates', () => {
    it('should search', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/search', { q: 'test', page: 1 });
    });
  });
  ...
  describe('getSmartRecommendations', () => {
    it('should get recommendations', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/smart-recommend', { ticketType: 'incident' });
    });
  });
  ...
  describe('favoriteTemplate', () => {
    it('should favorite', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/1/favorite');
    });
  });
  ...
  describe('unfavoriteTemplate', () => {
    it('should unfavorite', async () => {
      ...
      expect(mockDelete).toHaveBeenCalledWith('/api/v1/tickets/templates/1/favorite');
    });
  });
  ...
  describe('getFavoriteTemplates', () => {
    it('should get favorites', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/favorites');
    });
  });
  ...
  describe('isFavorite', () => {
    it('should check favorite status', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/1/favorite/status');
  ...
  describe('previewTicketFromTemplate', () => {
    it('should preview ticket from template', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/preview-ticket', { templateId: '1' });
    });
  });
  ...
  describe('getRecommendedTemplates', () => {
    it('should get recommended templates with userId', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/recommended', { userId: 'user1' });
    });

    it('should get recommended templates without userId', async () => {
      mockGet.mockResolvedValue([]);
      await TemplateApi.getRecommendedTemplates();
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/recommended', { userId: undefined });
    });
  });
  ...
  describe('getUserRating', () => {
    it('should get user rating', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/1/ratings/user1');
    });
  });
  ...
  describe('exportTemplates', () => {
    it('should batch export templates', async () => {
      ...
      expect(mockRequest).toHaveBeenCalledWith(expect.objectContaining({ method: 'POST', url: '/api/v1/tickets/templates/export/batch' }));
    });
  });
  ...
  describe('importTemplate', () => {
    it('should import template with File', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/import', expect.any(FormData));
    });
  ...
  describe('batchArchiveTemplates', () => {
    it('should batch archive', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/batch/archive', { templateIds: ['1', '2'] });
    });
  });
  ...
  describe('batchUpdateCategory', () => {
    it('should batch update category', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/batch/update-category', { templateIds: ['1', '2'], categoryId: 'cat1' });
    });
  });
  ...
  describe('getFieldSuggestions', () => {
    it('should get field suggestions', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/field-suggestions', { categoryId: 'cat1' });
    });
  });
  ...
  describe('getCommonFields', () => {
    it('should get common fields', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/api/v1/tickets/templates/common-fields');
    });
  });
  ...
  describe('generatePreview', () => {
    it('should generate preview', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/1/preview', { sampleData: { title: 'Test' } });
    });
  });
  ...
  describe('testAutomation', () => {
    it('should test automation', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/api/v1/tickets/templates/1/test-automation', { testData: { title: 'Test' } });
    });
  });
});
