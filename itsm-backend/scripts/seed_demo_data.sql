...
-- Generic improvements use the Intake API and generic_subtype configuration.
...
UNION ALL SELECT 'improvement_tickets', count(*) FROM tickets WHERE record_class='generic' AND generic_subtype='improvement';
