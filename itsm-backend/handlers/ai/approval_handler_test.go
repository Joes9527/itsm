...
func TestToolApprovalHTTPFailureClassification(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"conflict", ai.ErrToolApprovalConflict, 409},
		{"scope", executionscope.ErrDenied, 403},
		{"permission", creation.NewPermissionDenied("private-detail", nil), 403},
		{"missing", &ent.NotFoundError{}, 404},
		{"database", errors.New("private-detail"), 500},
		{"committed queue unavailable", nil, 503},
	} {
