DO $reset$ BEGIN IF EXISTS(SELECT 1 FROM service_requests) THEN RAISE EXCEPTION 'Refusing destructive ServiceRequest reset on populated data'; END IF; END $reset$;
