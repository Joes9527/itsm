...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.ChangeListResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/workitemcreation.CreateWorkItemResult"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/changes/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Professional extension ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/change.MetadataRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/workitemmutation.Result"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/standard-changes/{id}/instantiate": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.InstantiateStandardChangeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/work-items/{id}/relations": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Source WorkItem ID (read may traverse either endpoint)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/relationmetadata.View"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Observed source version, stable operationId, exact directed endpoints and typed metadata",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.WorkItemRelationRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.CreateChangeRequest": {
            ...
            "properties": {
                ...
                "sourceRelations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/workitemcreation.SourceRelationInput"
                    }
                },
                "title": {
                    "description": "变更标题",
        ...
        "dto.CreateProblemRequest": {
            ...
            "properties": {
                "cti": {
                    "$ref": "#/definitions/workitemcreation.CTIInput"
                },
                "description": {
                    "type": "string",
                    "maxLength": 5000,
        ...
        "dto.InstantiateStandardChangeRequest": {
            "type": "object",
            "properties": {
                "affectedCis": {
                    "description": "受影响配置项（可覆盖）",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "dto.ProblemResponse": {
            ...
            "properties": {
                ...
                "relations": {
                    "description": "Relations is omitted in metadata mutation responses without a current-authorized query; reads return an array, including empty.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/relationmetadata.View"
                    }
        ...
        "dto.WorkItemRelationRequest": {
            ...
            "properties": {
                ...
                "metadata": {
                    "$ref": "#/definitions/relationmetadata.Metadata"
                },
                "operationId": {
                    "type": "string"
                },
        ...
        "workitemcreation.CreateWorkItemResult": {
            "type": "object",
            "properties": {
                "number": {
                    "type": "string"
                ...
                "professionalReference": {
                    "$ref": "#/definitions/workitemcreation.ProfessionalReference"
                },
                "recordClass": {
                    "type": "string"
                },
        ...
        "workitemcreation.ProfessionalReference": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "workitemcreation.SourceRelationInput": {
            "type": "object",
            "properties": {
                "expectedVersion": {
                    "type": "integer"
