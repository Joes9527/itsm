...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			catalogaccesspolicy.Table:          catalogaccesspolicy.ValidColumn,
			...
			servicerequestaccessresult.Table:   servicerequestaccessresult.ValidColumn,
			servicerequestaccesssnapshot.Table: servicerequestaccesssnapshot.ValidColumn,
