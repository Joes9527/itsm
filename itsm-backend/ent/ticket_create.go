...
func (_c *TicketCreate) SetIncidentID(id int) *TicketCreate {
...
func (_c *TicketCreate) SetNillableIncidentID(id *int) *TicketCreate {
	if id != nil {
...
func (_c *TicketCreate) SetIncident(v *Incident) *TicketCreate {
	return _c.SetIncidentID(v.ID)
}

// SetServiceRequestID sets the "service_request" edge to the ServiceRequest entity by ID.
func (_c *TicketCreate) SetServiceRequestID(id int) *TicketCreate {
	_c.mutation.SetServiceRequestID(id)
	return _c
}
...
func (_c *TicketCreate) SetNillableServiceRequestID(id *int) *TicketCreate {
	if id != nil {
		_c = _c.SetServiceRequestID(*id)
	}
	return _c
}

// SetServiceRequest sets the "service_request" edge to the ServiceRequest entity.
func (_c *TicketCreate) SetServiceRequest(v *ServiceRequest) *TicketCreate {
	return _c.SetServiceRequestID(v.ID)
}
...
func (_c *TicketCreate) createSpec() (*Ticket, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.ServiceRequestIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
...
// SetTicketNumber sets the "ticket_number" field.
func (u *TicketUpsert) SetTicketNumber(v string) *TicketUpsert {
	u.Set(ticket.FieldTicketNumber, v)
	return u
}

// UpdateTicketNumber sets the "ticket_number" field to the value that was provided on create.
func (u *TicketUpsert) UpdateTicketNumber() *TicketUpsert {
	u.SetExcluded(ticket.FieldTicketNumber)
	return u
}
...
// SetTicketNumber sets the "ticket_number" field.
func (u *TicketUpsertOne) SetTicketNumber(v string) *TicketUpsertOne {
	return u.Update(func(s *TicketUpsert) {
		s.SetTicketNumber(v)
	})
}
...
// UpdateTicketNumber sets the "ticket_number" field to the value that was provided on create.
func (u *TicketUpsertOne) UpdateTicketNumber() *TicketUpsertOne {
	return u.Update(func(s *TicketUpsert) {
...
// SetTicketNumber sets the "ticket_number" field.
func (u *TicketUpsertBulk) SetTicketNumber(v string) *TicketUpsertBulk {
	return u.Update(func(s *TicketUpsert) {
		s.SetTicketNumber(v)
	})
}
...
// UpdateTicketNumber sets the "ticket_number" field to the value that was provided on create.
func (u *TicketUpsertBulk) UpdateTicketNumber() *TicketUpsertBulk {
	return u.Update(func(s *TicketUpsert) {
		s.UpdateTicketNumber()
	})
}
