...
var (
	...
	IncidentsColumns = []*schema.Column{
		...
		{Name: "incident_number", Type: field.TypeString},
	...
	// KafTaskActionLedgersColumns holds the columns for the "kaf_task_action_ledgers" table.
	KafTaskActionLedgersColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "tenant_id", Type: field.TypeInt},
	...
	// KafTaskActionLedgersTable holds the schema information for the "kaf_task_action_ledgers" table.
	KafTaskActionLedgersTable = &schema.Table{
		Name:       "kaf_task_action_ledgers",
		Columns:    KafTaskActionLedgersColumns,
		PrimaryKey: []*schema.Column{KafTaskActionLedgersColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "kaftaskactionledger_tenant_id_task_id_run_id_step_id",
				Unique:  true,
				Columns: []*schema.Column{KafTaskActionLedgersColumns[1], KafTaskActionLedgersColumns[2], KafTaskActionLedgersColumns[3], KafTaskActionLedgersColumns[4]},
			},
			{
				Name:    "kaftaskactionledger_tenant_id_idempotency_key",
				Unique:  true,
				Columns: []*schema.Column{KafTaskActionLedgersColumns[1], KafTaskActionLedgersColumns[6]},
			},
		},
	}
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{TicketsColumns[15], TicketsColumns[11]},
			},
			{
				Name:    "ticket_status",
				Unique:  false,
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{TicketsColumns[15], TicketsColumns[47]},
			},
			{
				Name:    "ticket_tenant_id_external_message_id",
				Unique:  false,
				Columns: []*schema.Column{TicketsColumns[15], TicketsColumns[13]},
			},
			{
				Name:    "ticket_tenant_id_conversation_id",
				Unique:  true,
				Columns: []*schema.Column{TicketsColumns[15], TicketsColumns[14]},
			},
			{
				Name:    "ticket_status_priority",
				Unique:  false,
				Columns: []*schema.Column{TicketsColumns[3], TicketsColumns[10]},
			},
			{
				Name:    "ticket_requester_id_status",
				Unique:  false,
				Columns: []*schema.Column{TicketsColumns[47], TicketsColumns[3]},
			},
			{
				Name:    "ticket_tenant_id_record_class",
				Unique:  false,
				Columns: []*schema.Column{TicketsColumns[15], TicketsColumns[7]},
			},
		},
	}
	...
	TicketCcsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{TicketCcsColumns[3], TicketCcsColumns[7], TicketCcsColumns[1]},
	...
	TicketCategoriesColumns = []*schema.Column{
		...
		{Name: "is_active", Type: field.TypeBool, Default: true},
		{Name: "tenant_id", Type: field.TypeInt},
		{Name: "itsm_type", Type: field.TypeString, Nullable: true},
		{Name: "default_priority", Type: field.TypeString, Nullable: true},
		{Name: "sla_tier", Type: field.TypeString, Nullable: true},
		{Name: "default_resolver", Type: field.TypeString, Nullable: true},
		{Name: "is_user_facing", Type: field.TypeBool, Default: true},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "department_id", Type: field.TypeInt, Nullable: true},
		{Name: "parent_id", Type: field.TypeInt, Nullable: true},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{TicketCategoriesColumns[15]},
				RefColumns: []*schema.Column{DepartmentsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "name", Type: field.TypeString},
		{Name: "role", Type: field.TypeString, Default: "end_user"},
		{Name: "department", Type: field.TypeString, Nullable: true},
