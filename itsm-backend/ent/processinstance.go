...
type ProcessInstance struct {
	...
	// 结构化业务类型（recordClass：generic/service_request_item/incident/problem/change_request/catalog_task，历史保留值 release），迁移期与 business_key 由同一次 TriggerProcess 调用原子写入，不从 variables JSON 里现取
