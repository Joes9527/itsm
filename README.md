...
> **当前阶段：v1.1 稳定性加固。** v1.0 已完成核心流程、BPMN、CMDB v1、SLA、RBAC、多租户和部署基础；当前重点是接口与测试覆盖、连接器市场 v1、权限加固和 AI 审计。生产落地前仍应按企业规模完成安全配置、备份恢复、容量测试、SSO/组织同步和灾备验收，详见[生产初始化运维手册](./docs/runbooks/production-initialization.md)。
