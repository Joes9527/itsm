...
| Dev workflow recovery or same-database validation clone | [Restoration design](docs/superpowers/specs/2026-09-16-dev-restoration-two-database-design.md), [workflow task package](docs/superpowers/plans/2026-09-16-dev-workflow-recovery.md), [schema-clone task package](docs/superpowers/plans/2026-09-16-schema-validation-clone.md), and [single execution ledger](docs/superpowers/plans/2026-09-15-migration-validation-ledger.md#two-database-execution); distinguish accepted direction, draft implementation gates, and actual execution evidence |
