...
## CTI design review boundary

The [CTI governance design](docs/superpowers/specs/2026-09-17-cti-governance-design.md) records the agreed direction and is pending written-spec review. Read it before changing classification, catalog defaults or completion gates. It is not implemented behavior or deployment authorization; do not activate new gates from this draft. It distinguishes operational CTI from recordClass and portal catalog grouping, retains domain lifecycle owners, and documents compatibility with historical records.
