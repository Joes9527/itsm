...
## CTI accepted design boundary

The [CTI governance design](docs/superpowers/specs/2026-09-17-cti-governance-design.md) records the accepted direction and review clarifications. Read it before changing classification, catalog defaults or completion gates. It is not implemented behavior or deployment authorization; activate new gates only through the documented implementation and authorized rollout. The [implementation plan](docs/superpowers/plans/2026-09-17-cti-governance.md) is not yet executed. It distinguishes operational CTI from recordClass and portal catalog grouping, retains domain lifecycle owners, and documents compatibility with historical records.
