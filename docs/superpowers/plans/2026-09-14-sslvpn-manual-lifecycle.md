...
- [x] 核对用户/组/角色、目录表单、审批弹窗、分派弹窗的实际控件及字段。
- [x] 主手册替换为 OP00–OP22 功能步骤，每项包含具体输入数据和结果检查。
- [x] 邮件手册替换为 EM01–EM12，从连接器字段到解决/关闭逐功能编排。
- [x] 执行说明、模板和入口索引使用功能子步骤，移除故事分幕执行要求。
- [x] 检查 44 个文档/源码链接、23 个 OP 与 12 个 EM 功能编号、旧数据引用和文档差异；未执行实际业务测试。
