...
- [ ] **Step 2: Run the tests and confirm the missing migration failure**
...
- [ ] **Step 3: Define the Ent schemas and enable SQL upsert generation**
...
- [ ] **Step 5: Register migration 020 and RLS policies**
...
- [ ] **Step 6: Run schema, migration and RLS-focused tests**
...
- [ ] **Step 3: Implement the command and result types**
...
- [ ] **Step 4: Implement canonicalization version `intake-v1`**
...
- [ ] **Step 1: Write failing exact-replay and rollback tests**
...
- [ ] **Step 3: Implement atomic claim with generated Ent upsert**
...
- [ ] **Step 4: Add tx-aware FieldValue creation**
...
- [ ] **Step 5: Implement Snapshot and audit writers**
...
- [ ] **Step 6: Add deterministic workflow event helper**
...
- [ ] **Step 8: Commit transaction contributors**
...
- [ ] **Step 1: Write failing resolver table tests**
...
- [ ] **Step 3: Make Catalog reads transaction-aware**
...
- [ ] **Step 4: Resolve and freeze the exact workflow definition**
...
- [ ] **Step 5: Implement deterministic reference and permission validation**
...
- [ ] **Step 1: Write failing registry and creator tests**
...
- [ ] **Step 3: Implement the WorkItem base writer**
...
- [ ] **Step 4: Implement `IncidentCreator`**
...
- [ ] **Step 5: Implement `ServiceRequestItemCreator`**
...
- [ ] **Step 7: Commit creator boundaries**
...
- [ ] **Step 1: Write the fault-injection and replay test matrix**
...
- [ ] **Step 3: Implement the one-transaction orchestration**
...
- [ ] **Step 4: Prove rollback and concurrency on PostgreSQL**
...
- [ ] **Step 5: Run the complete Intake package**
...
- [ ] **Step 2: Run handler/router tests and verify missing route**
...
- [ ] **Step 3: Implement strict decoding and ActorResolver**
...
- [ ] **Step 4: Wire bootstrap and route permissions**
...
- [ ] **Step 5: Return exact status codes**
...
- [ ] **Step 1: Write crash-window, duplicate and dead-letter tests**
...
- [ ] **Step 3: Refactor BPMN start around an exact definition**
...
- [ ] **Step 4: Implement the dispatcher and terminal failure**
...
- [ ] **Step 5: Add lifecycle configuration**
...
- [ ] **Step 6: Add tenant-scoped manual intervention**
...
- [ ] **Step 1: Write failing adapter and frontend header tests**
...
- [ ] **Step 3: Add stable frontend keys**
...
- [ ] **Step 4: Convert Incident and Service Request handlers to thin adapters**
...
- [ ] **Step 5: Delete the replaced creation implementation**
...
- [ ] **Step 2: Run authority tests and capture current dual-source failures**
...
- [ ] **Step 3: Move all reads to WorkItem joins**
...
- [ ] **Step 4: Add irreversible migration 021 and update schemas**
...
- [ ] **Step 5: Regenerate Ent and fix compile-time references**
...
- [ ] **Step 6: Search for forbidden dual authority**
...
- [ ] **Step 7: Commit authority convergence**
...
- [ ] **Step 1: Write failing exchange and route-isolation tests**
...
- [ ] **Step 3: Load dedicated exchange configuration**
...
- [ ] **Step 4: Verify a canonical connector assertion**
...
- [ ] **Step 5: Map identity and issue an intake-only JWT**
...
- [ ] **Step 6: Add audited mapping lifecycle endpoints**
...
- [ ] **Step 7: Add isolated Intake authentication**
...
- [ ] **Step 9: Commit identity exchange**
...
- [ ] **Step 1: Create an isolated KAF worktree and verify baseline dirt**
...
- [ ] **Step 2: Write failing typed-client and tool tests**
...
- [ ] **Step 3: Run focused KAF tests and verify failure**
...
- [ ] **Step 4: Implement typed contracts and client**
...
- [ ] **Step 5: Replace `ticket_create` behavior**
...
- [ ] **Step 6: Update structured callers and remove creation fallbacks**
...
- [ ] **Step 7: Run focused KAF validation**
...
- [ ] **Step 8: Commit the KAF cutover in the KAF worktree**
...
- [ ] **Step 1: Write failing metric and E2E assertions**
...
- [ ] **Step 2: Run focused E2E and verify missing metrics**
...
- [ ] **Step 3: Implement bounded metrics and documentation**
...
- [ ] **Step 4: Run ITSM focused and full verification**
...
- [ ] **Step 5: Run mandatory PostgreSQL RLS verification**
...
- [ ] **Step 6: Run KAF focused and repository-wide verification**
...
- [ ] **Step 7: Run Dev real-path acceptance without production writes**
...
- [ ] **Step 9: Commit metrics, docs and evidence**
