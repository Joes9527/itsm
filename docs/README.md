...
- [旧路由可表达性重算（生产口径，只读，2026-09-18）](./review/2026-09-18-legacy-routing-expressibility-production.md)：用生产导出重算 1085 行的可表达性。**关键修正：其中 128 行属知识库审批流、非工单派单**；工单派单 957 行 100% 为"指定人"口径，872 可直接表达 / 85 为失效引用。**该结论是上界**，未校验新旧分类映射与新库人员在职。**只读分析，非迁移授权。**
