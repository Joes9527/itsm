...
CTI changes must read the [accepted CTI design](docs/superpowers/specs/2026-09-17-cti-governance-design.md) and [AGENTS design boundary](AGENTS.md#cti-accepted-design-boundary). Its agreed direction is not implemented behavior or authorization to activate classification/completion gates.
