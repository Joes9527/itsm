...
CTI changes must read the [pending-review CTI design](docs/superpowers/specs/2026-09-17-cti-governance-design.md) and [AGENTS review boundary](AGENTS.md#cti-design-review-boundary). Its agreed direction is not implemented behavior or authorization to activate classification/completion gates.
